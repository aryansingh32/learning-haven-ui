...
export interface AuthContextType {
  ...
  register: (data: { email: string; password: string; full_name: string; referral_code?: string }) => Promise<void>;
  logout: () => void;
}
...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const register = async (data: { email: string; password: string; full_name: string; referral_code?: string }) => {

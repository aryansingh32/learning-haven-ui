          ...
          >
            <div className="min-w-0">
              {problem.url && problem.url !== '#' ? (
                <a href={problem.url} target="_blank" rel="noreferrer" className="text-sm font-semibold text-foreground hover:underline hover:text-primary transition-colors inline-flex items-center gap-1">
                  {problem.name}
                  <svg className="w-3 h-3 text-muted-foreground" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>
                </a>
              ) : (

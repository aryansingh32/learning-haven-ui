...
export default function ChapterPage() {
  ...
  // Generic fallback mission since the backend schema doesn't support complex chapter steps yet
  const mission = useMemo(() => {
    ...
    return {
      ...
      storyIntro: 'Welcome to this chapter. Here you will learn new concepts.',
      difficulty: 'medium',
      timeMinutes: 30,
      reward: { xp: 100, badge: 'Scholar' },
      steps: [
        { id: 's1', title: 'Story Hook', type: 'story_hook', storyContent: 'Let\'s get started.' },
        { id: 's2', title: 'Video', type: 'video', videoTitle: 'Concept Video', videoDuration: '10m', videoUrl: 'https://www.youtube.com/embed/example', videoNote: 'Focus on basics' },
  ...
  if (!mission) {
    return (
      <div className="max-w-7xl mx-auto card-layer-2 rounded-2xl p-6 text-center">
        ...
        <p className="text-sm text-muted-foreground mt-2">Choose a chapter from the course.</p>
        <button

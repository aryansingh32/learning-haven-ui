...
import { ApprenticeshipOpportunities } from '@/features/apprenticeship/components/ApprenticeshipOpportunities';
            ...
            <div className="min-h-[400px]">
                {isLoading && page === 1 ? (
                    ...
                    >
                        ...
                        <p className="text-muted-foreground text-body mb-6 max-w-md">New opportunities are added regularly. Meanwhile, explore apprenticeships or set up job alerts.</p>
                        <div className="flex flex-wrap gap-3 justify-center">
                            <button
                                onClick={() => setActiveTab('INTERNSHIP')}
                                className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-5 py-2.5 rounded-xl text-sm font-semibold hover:bg-primary/90 focus-visible:ring-2 focus-visible:ring-primary"
                            >
                                Browse Internships
                            </button>
                            <a
                                href="/courses"
                                className="inline-flex items-center gap-2 bg-secondary text-foreground px-5 py-2.5 rounded-xl text-sm font-semibold hover:bg-secondary/80"
                            >
                                Build Skills First
                            </a>
                        </div>

...
import { sendProjectPassedEmail } from '../modules/communication/services/email.service';
...
const deadLetterQueue = new Queue('apprenticeship-verification-dlq', {
...
worker.on('failed', async (job, error) => {
  ...
  await deadLetterQueue.add('failed_verification_job', {
    failedJobId: job.id,

...
import notebookRoutes from '../../learning/routes/notebook';
import mockTestRoutes from '../../learning/routes/mock-test';
...
import userResumeRouter from '../../auth/routes/resume';
import jobBookmarksRouter from '../../auth/routes/jobs.bookmarks';
...
router.use('/user-resume', userResumeRouter);
router.use('/user-jobs', jobBookmarksRouter);

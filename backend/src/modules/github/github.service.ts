...
const ENCRYPTION_KEY = process.env.GITHUB_TOKEN_ENCRYPTION_KEY || 'development-github-token-key-32-bytes';
const WEBHOOK_BASE_URL = process.env.WEBHOOK_BASE_URL || 'https://api.learninghaven.com';

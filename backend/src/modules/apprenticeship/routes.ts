...
router.post('/payments/create-order', authenticateUser, apprenticeshipTracker('checkout_initiated', 'payment'), EnrollmentController.createOrder);
router.post('/enroll', authenticateUser, apprenticeshipTracker('enrollment_completed', 'payment'), EnrollmentController.enroll);
...
router.get('/projects/:projectId', authenticateUser, apprenticeshipTracker('page_view', 'navigation'), ApprenticeshipController.getProjectWorkspace);
router.post('/projects/:projectId/start', authenticateUser, apprenticeshipTracker('project_started', 'verification'), ApprenticeshipController.startProject);
...
router.post('/ai/project-help', authenticateUser, aiHelpRateLimit, apprenticeshipTracker('ai_help_query', 'ai'), AIHelpController.getHelp);
